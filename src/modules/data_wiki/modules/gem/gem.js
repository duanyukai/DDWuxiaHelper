...
const gemPicPath = require.context('./assets/imgs', true);
...
let zhanliCoMap = {
  '力道': 0.18, '气劲': 0.18, '洞察': 0.18, '身法': 0.18, '根骨': 0.18,
  '外功攻击': 0.84, '内功攻击': 1.08, '外功防御': 0.18, '内功防御': 0.18,
                    ...
                    return (
                      <Tabs.TabPane key={i} tab={levelKey}>
                        <div>
                          ...
                          <span style={{fontSize: 14}}>【多玩天刀攻略团】 段段制作</span>，多玩论坛帖子链接：http://bbs.duowan.com/thread-46427162-1-1.html，本数据页面：https://www.wuxiatools.com/data/gem，转载请注明链接与出处“多玩论坛-段段”。
                        </div>
                        <br />
                        <Table
                          styleName="gem-table"
